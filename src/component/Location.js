  ...
  return (
    ...
    <Box sx={{
      ...
      <Grid container sx={{ maxWidth: '1300px' }}>
        <Grid item lg={6} xs={12} sx={{ p: 5, px: { lg: 10, xs: 0 }, display:'flex', flexDirection:'column', justifyContent:'center', alignItems:{lg:'start', xs:'center'} }}>
          ...
          <Button sx={{
            bgcolor: '#FB561E', color: '#fff', borderRadius: 10, px: 3, fontSize: { lg: '18px', xs: '16px' }, fontFamily: 'Inter', fontWeight: 500, '&:hover': {
              color: '#fff',
